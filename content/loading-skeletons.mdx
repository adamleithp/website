...
Here's our Tailwind classes in pure CSS;
...
Now we simply wrap each individual text elements in `<TextSkeleton>` and we're done!
...
If you wanted to take a bit further, and you project has a strict style guide/ ui component library, you can add a `loading` prop to your components and conditionally render the skeleton.
