...
<div className="max-w-64">
  <InputPassword label="Password" defaultValue="some-super-password" />
</div>
...
You can find the full code for this component in the [source code](https://github.com/adamleithp/website/blob/main/components/examples/input-password.tsx)
